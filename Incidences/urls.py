...
from Incidences.views import HomePageView,building_datasets,cagb_datasets,finance_datasets,openspace_datasets,road_datasets,school_datasets,health_datasets,ward_datasets,waterway_datasets,search_facility,about,contact,proad_datasets,user_login,registration,community_building,financial_institution,health_facility,houses,openspace,road,schools,waterways,savemessage
urlpatterns = [
